...
function GM:HUDPaint()
	...
	if self:GetState() == STATE_ENDING then
		...
		draw.SimpleShadowText( "GAME ENDED", "HudHuge", ScrW()/2, ScrH()/2 - 132, Color( 255, 255, 255 ), Color( 0, 0, 0, 220 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 0, 0, 2 )
		draw.SimpleShadowText( "SENDING YOU ALL BACK TO THE LOBBY", "HudNormal", ScrW()/2, ScrH()/2 - 42, Color( 255, 255, 255 ), Color( 0, 0, 0, 220 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 0, 0, 2 )
		return
	end
...
function GM:DrawHUDMaterials( outx, outy )
	...
	surface.SetTexture( HUDTime )
	surface.SetDrawColor( color.r, color.g, color.b, alpha )
	surface.DrawTexturedRect( 0, ScrH() - 112, 350 - outx, 82 - outy )

	surface.SetDrawColor( Color( 255, 255, 255, 255 ) )
	surface.SetMaterial( KeyMat )
	surface.DrawTexturedRect( 82, ScrH() - 82 - 16, 32 - outx, 32 - outy )
	surface.SetTextColor( Color( 11, 11, 11, 255 ) )
	surface.SetTextPos(85 + 3 - outx, ScrH() - 32 - 61 - 2.5 - outy)
	surface.SetFont("HudTinyAlt")
	surface.DrawText("R")
	surface.SetTextColor( Color( 255, 255, 255, 255 ) )
	surface.SetFont("HudSmallAlt")
	surface.SetTextPos(92 + 3 + 35 - outx, ScrH() - 77.5 - 16 - 6 - outy)
