...
net.Receive("UpdateShowDelay", function()
	local stage = net.ReadEntity()
	local time = net.ReadFloat()

	if !IsValid( stage ) or stage:GetClass() != "stage" then return end

	stage.ShowTimeRemaining = (time or 0) * 60

	GTowerChat.Chat:AddText("4th of July Show starting in" .. string.NiceTime( stage.ShowTimeRemaining ) .. "!", Color( 255, 50, 50, 255 ))
end)

net.Receive("StartShow", function()
	local stage = net.ReadEntity()
	...
	GTowerChat.Chat:AddText("4th of July Show starting now!", Color( 255, 50, 50, 255 ))
end)