...
hook.Add("StartCommand", "Playback", function(ply, cmd)
  if ply:IsBot() then
    ...
    if ply.Ball then
      //cur.Buttons = cur.Buttons + (cur.Move[1] < 0 and IN_BACK or cur.Move[1] > 0 and IN_FORWARD or 0) + (cur.Move[2] < 0 and IN_MOVELEFT or cur.Move[2] > 0 and IN_MOVERIGHT or 0)
    end
