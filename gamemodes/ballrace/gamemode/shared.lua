...
music.Register( MUSIC_LEVEL, "music/skyworld", { Length = 83, Loops = true }, "gmt_ballracer_skyworld" )
music.Register( MUSIC_LEVEL, "music/grassworld", { Length = 126, Loops = true }, "gmt_ballracer_grassworld" )
music.Register( MUSIC_LEVEL, "BallsMusicWMemories", { Length = 259, Loops = true }, "gmt_ballracer_memories" )
music.Register( MUSIC_LEVEL, "music/paradise", { Length = 304, Loops = true }, "gmt_ballracer_paradise" )
