function GM:CalcMainActivity( ply, velocity )
	...
	if model == "models/player/zombie_classic.mdl" && Hats.IsWearing( ply, "hatheadcrab" ) && ply:IsOnGround() && (ply.CalcIdeal == ACT_MP_STAND_IDLE || ply.CalcIdeal == ACT_MP_WALK || ply.CalcIdeal == ACT_MP_RUN) && !ply:InVehicle() then
