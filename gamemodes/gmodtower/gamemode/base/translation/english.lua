...
L.AddWord( 1, "MiniStoreGameEnd",	"The sale at the {1} has ended.")
L.AddWord( 1, "MiniBalloonGameStart",	"Shoot all the balloons in the {1}!")
L.AddWord( 1, "MiniGhostGameStart",	"Shoot all the ghosts in the {1}!")
L.AddWord( 1, "MiniObamaGameStart",	"The Obama cutouts are spreading in the {1}! Smash them all!")
L.AddWord( 1, "MiniNoScale",	"You cannot use potions while in a minigame!")
L.AddWord( 1, "MiniNext",	"Starting next event in {1} minutes.")
L.AddWord( 1, "MiniTotal",	"A total of {1} GMC was made during this minigame!")
...
L.AddWord( 1, "DuelInviteFailFunds",	"You, or {1} do not have enough GMC for this duel. Please lower the bet and try again." )
