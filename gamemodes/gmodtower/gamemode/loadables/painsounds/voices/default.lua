...
voicelins.Add("models/player/skeleton.mdl", zombie) // TODO: do some funny bone noises
voicelins.Add("models/player/zombie_classic.mdl", zombie)
voicelins.Add("models/player/zombie_fast.mdl", zombie)
voicelins.Add("models/player/zombie_soldier.mdl", zombie)

voicelins.Add("models/player/arctic.mdl", cs_bot)
voicelins.Add("models/player/gasmask.mdl", cs_bot)
voicelins.Add("models/player/leet.mdl", cs_bot)
voicelins.Add("models/player/phoenix.mdl", cs_bot)
voicelins.Add("models/player/riot.mdl", cs_bot)
voicelins.Add("models/player/swat.mdl", cs_bot)
voicelins.Add("models/player/urban.mdl", cs_bot)
