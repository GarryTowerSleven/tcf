...
voicelines.SetFemale("models/player/alice.mdl")
voicelines.SetFemale("models/player/reimupc.mdl")
voicelines.SetFemale("models/custom/asterisk/nitw/mae/mae_pm.mdl")
voicelines.SetFemale("models/player/pyroteknik/vibri.mdl")