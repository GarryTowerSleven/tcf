...
Add( 5, "Suites 1 - 9", "suites", Vector( 4736, -10600, 4096 ), Vector( 4356, -12508, 4328 ), true )
Add( 60, "Suites 10 - 15", "suites", Vector( 1800, -10370, 4096 ), Vector( 4048, -9985, 4328 ), true )
Add( 6, "Suites 16 - 24", "suites", Vector( 4736, -9792, 4096 ), Vector( 4356, -7855, 4328 ), true )
...
Add( 11, "Suite #1", "suite", Vector( 4733, -11208, 4085 ), Vector( 6048, -10840, 4365 ), true, 1 )
Add( 12, "Suite #2", "suite", Vector( 4734, -11592, 4085 ), Vector( 6049, -11224, 4365 ), true, 2 )
Add( 13, "Suite #3", "suite", Vector( 4734, -11976, 4085 ), Vector( 6049, -11608, 4365 ), true, 3 )
Add( 14, "Suite #4", "suite", Vector( 4734, -12360, 4085 ), Vector( 6049, -11992, 4365 ), true, 4 )
Add( 15, "Suite #5", "suite", Vector( 4416, -13824, 4085 ), Vector( 4784, -12509, 4365 ), true, 5 )
Add( 16, "Suite #6", "suite", Vector( 3039, -12360, 4085 ), Vector( 4354, -11992, 4365 ), true, 6 )
Add( 17, "Suite #7", "suite", Vector( 3039, -11976, 4085 ), Vector( 4354, -11608, 4365 ), true, 7 )
Add( 18, "Suite #8", "suite", Vector( 3039, -11592, 4085 ), Vector( 4354, -11224, 4365 ), true, 8 )
Add( 19, "Suite #9", "suite", Vector( 3039, -11208, 4085 ), Vector( 4354, -10840, 4365 ), true, 9 )
Add( 20, "Suite #10", "suite", Vector( 2624, -11681, 4085 ), Vector( 2992, -10366, 4365 ), true, 10 )
Add( 21, "Suite #11", "suite", Vector( 2240, -11681, 4085 ), Vector( 2608, -10366, 4365 ), true, 11 )
Add( 22, "Suite #12", "suite", Vector( 1856, -11681, 4085 ), Vector( 2224, -10366, 4365 ), true, 12 )
Add( 23, "Suite #13", "suite", Vector( 1792, -9986, 4085 ), Vector( 2160, -8671, 4365 ), true, 13 )
Add( 24, "Suite #14", "suite", Vector( 2176, -9986, 4085 ), Vector( 2544, -8671, 4365 ), true, 14 )
Add( 25, "Suite #15", "suite", Vector( 2560, -9986, 4085 ), Vector( 2928, -8671, 4365 ), true, 15 )
Add( 26, "Suite #16", "suite", Vector( 3040, -9512, 4085 ), Vector( 4355, -9144, 4365 ), true, 16 )
Add( 27, "Suite #17", "suite", Vector( 3040, -9128, 4085 ), Vector( 4355, -8760, 4365 ), true, 17 )
Add( 28, "Suite #18", "suite", Vector( 3040, -8744, 4085 ), Vector( 4355, -8376, 4365 ), true, 18 )
Add( 29, "Suite #19", "suite", Vector( 3040, -8360, 4085 ), Vector( 4355, -7992, 4365 ), true, 19 )
Add( 30, "Suite #20", "suite", Vector( 4304, -7855, 4085 ), Vector( 4672, -6540, 4365 ), true, 20 )
Add( 63, "Suite #21", "suite", Vector( 4732, -8360, 4085 ), Vector( 6047, -7992, 4365 ), true, 21 )
Add( 64, "Suite #22", "suite", Vector( 4732, -8744, 4085 ), Vector( 6047, -8376, 4365 ), true, 22 )
Add( 65, "Suite #23", "suite", Vector( 4732, -9128, 4085 ), Vector( 6047, -8760, 4365 ), true, 23 )
Add( 66, "Suite #24", "suite", Vector( 4732, -9512, 4085 ), Vector( 6047, -9144, 4365 ), true, 24 )
