...
Add( 55, {
    Name = "Lakeside Cabin",
    Group = "lakeside",
    Min = Vector( -10880.752929688, 9390.5859375, -81.03352355957 ),
    Max = Vector( -10170.448242188, 9920.134765625, 380.35539245605 ),
    Priority = 0,
} )
Add( 56, {
    Name = "Pool",
...
Add( 4, {
    Name = "Suites",
    Group = "suites",
    Min = Vector(4048,-10680,4096),
    Max = Vector(5440,-9673,4480),
    IsSuite = true,
    SuiteID = 0,
    Priority = 0,
} )
Add( 5, {
    Name = "Suites 1 - 5",
    Group = "suites",
    Min = Vector(4351,-11649,4096),
    Max = Vector(4737,-10680,4334),
    IsSuite = true,
    SuiteID = 0,
    Priority = 0,
} )
...
Add( 6, {
    Name = "Suites 6 - 10",
    Group = "suites",
    Min = Vector(4351,-9673,4096),
    Max = Vector(4737,-8704,4334),
    IsSuite = true,
    SuiteID = 0,
    Priority = 0,
} )
