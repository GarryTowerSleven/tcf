...
RegisterItem("infernochair",{
	Name = "Old Comfy Chair",
	Description = "Made from the finest of materials.",
	Model = "models/props/de_inferno/hr_i/inferno_chair/inferno_chair.mdl",
	UniqueInventory = false,
	DrawModel = true,
	StoreId = 1,
	StorePrice = 350,
...
RegisterItem("nukechair",{
	Name = "Office Chair",
	Description = "No arm rests included.",
	Model = "models/props/de_nuke/hr_nuke/nuke_chair/nuke_chair.mdl",
	UniqueInventory = false,
	DrawModel = true,
	StoreId = 1,
	StorePrice = 200,
...
RegisterItem("nukeofficechair",{
	...
	Description = "Arm rests included.",
...
RegisterItem("nukeofficedesk",{
	...
	Description = "Be professional and store your items on this beast of a desk!",
	Model = "models/props/de_nuke/hr_nuke/nuke_office_desk/nuke_office_desk.mdl",
	UniqueInventory = false,
	DrawModel = true,
	StoreId = 1,
	StorePrice = 750,
...
RegisterItem("nukedeskmonitor",{
	Name = "Modern Desk Monitor",
	Description = "Modern, but still 4:3...",
...
RegisterItem("vintageradio",{
	Name = "Vintage Radio",
	Description = "Video killed the radio star you know?",
	Model = "models/props/de_inferno/hr_i/inferno_vintage_radio/inferno_vintage_radio.mdl",
	UniqueInventory = false,
	DrawModel = true,
	StoreId = 7,
	StorePrice = 350,
...
RegisterItem("ppiece",{
	Name = "Puzzle Piece",
	Description = "One puzzle piece. Looks like this Puzzle is Impossible.",
