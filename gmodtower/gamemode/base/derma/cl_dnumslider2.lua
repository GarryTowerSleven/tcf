...
function PANEL:Paint( w, h )
	...
	local vardesc = tostring(val) --self.m_numMax)
...
function PANEL:ResizeSliderToTitle()
	...
	local w2 = surface.GetTextSize( "1000" ) + 6



	self.Slider:SetPos( w + 4, 0 )

	self.Slider:SetSize( self:GetWide() - w - w2, 13 )	
