...
PANEL.Scrollbar.BackgroundColor = Color( 16, 70, 101, 70 )
PANEL.Scrollbar.HoverColor = Color( 16 + b, 70 + b, 101 + b )
PANEL.Scrollbar.DepressedColor = Color( 16 - b, 70 - b, 101 - b )
