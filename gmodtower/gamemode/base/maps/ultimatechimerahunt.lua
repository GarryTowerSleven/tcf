...
Maps.Register( "gmt_uch_alpine01", {

	Name = "Alpine",

	Desc = "The Chimera has taken over the once peaceful town up in the mountains. Go stop it, just don't get hurt!",
...
Maps.Register( "gmt_uch_egypt01", {

	Name = "Egypt",

	Desc = "The Pigmasks have escaped to the far far Egyptic deserts, you wouldn't find the Chimera here... right?",
...
Maps.Register( "gmt_uch_newporkcity01", {

	Name = "New Pork City",

	Desc = "Welcomidos to New Pork City!",
