...
/*Maps.Register( "gmt_ballracer_memories04", {
	Name = "Memories",
	Desc = "New gameplay gimmicks - repellers and attracters that twist the concept of gravity. It contains the highest level count and randomly chosen left or right paths for replay value.",
	Author = "",
	DateAdded = 1339137397,
	DateModified = 1339252668,
	Priority = 4,
