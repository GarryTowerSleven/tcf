...
hook.Add("InitPostEntity","AddL2Ents",function()
	...
	AddL2Camera( Vector( -1154, 60.18159866333, 15100 ), Angle(0, 90, 0) )
	AddL2Camera( Vector( -672, 60.18159866333, 15100 ), Angle(0, 90, 0) )
	AddL2Camera( Vector( -192, 60.181701660156, 15100 ), Angle(0, 90, 0) )
	...
	AddL2Camera( Vector( -3940, 60.181499481201, 15100 ), Angle(0, 90, 0) )
	AddL2Camera( Vector( -3458, 60.181499481201, 15100 ), Angle(0, 90, 0) )
	AddL2Camera( Vector( -2978, 60.18159866333, 15100 ), Angle(0, 90, 0) )
