...
-----------------------------------------------------
/*Maps.Register( "gmt_sk_gravity", {
	Name = "Surface MKS Gravity Test",
	Desc = "Test",
	Author = "MKS Team",
...
Maps.Register( "gmt_sk_gravity2", {
	Name = "Surface Gravity Test",
	Desc = "Test",
	Author = "Gamedev",
	DateAdded = 1345328453,
	DateModified = 1345506617,
...
Maps.Register( "gmt_sk_lifelessraceway01", {
