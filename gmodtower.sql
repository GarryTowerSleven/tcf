...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 24, 2021 at 11:17 PM
...
--
-- Dumping data for table `gm_ballrace`
--

INSERT INTO `gm_ballrace` (`ply`, `name`, `map`, `lvl`, `time`) VALUES
('76561198049183436', 'Bumpy', 'gmt_ballracer_skyworld01', '1', 8.60999),
('76561198049183436', 'Bumpy', 'gmt_ballracer_skyworld01', '2', 11.925),
('76561198272530444', 'Basical', 'gmt_ballracer_skyworld01', '2', 12.15),
('76561198272530444', 'Basical', 'gmt_ballracer_skyworld01', '3', 12.27),
('76561198049183436', 'Bumpy', 'gmt_ballracer_skyworld01', '3', 21),
('76561198272530444', 'Basical', 'gmt_ballracer_skyworld01', '4', 31.755),
('76561198049183436', 'Bumpy', 'gmt_ballracer_skyworld01', '4', 41.385),
('76561198155010327', 'NotGaylien', 'gmt_ballracer_spaceworld', '1', 17.385),
('76561198049183436', 'Bumpy', 'gmt_ballracer_spaceworld', '2', 26.235),
('76561198049183436', 'Bumpy', 'gmt_ballracer_spaceworld', '3', 21.09),
('76561198049183436', 'Bumpy', 'gmt_ballracer_spaceworld', '4', 15.6),
('76561198155010327', 'NotGaylien', 'gmt_ballracer_spaceworld', '4', 16.47),
('76561198049183436', 'Bumpy', 'gmt_ballracer_spaceworld', '5', 39.465),
('76561198049183436', 'Bumpy', 'gmt_ballracer_spaceworld', '6', 8.63998),
('76561198155010327', 'NotGaylien', 'gmt_ballracer_spaceworld', '6', 25.23),
('76561198049183436', 'Bumpy', 'gmt_ballracer_spaceworld', '7', 26.385);
...
(88917708, '!l me:SetNWBool(\'inMonorail\',true)', '99'),
(88917708, '!l me:SetNWBool(\'inMonorail\',true)', '99'),
(88917708, '!l me:SetNWBool(\'inMonorail\', true)', '99'),
(88917708, '!l ents.FindByClass(\'gmt_monorail\')[1]:Remove()', '99'),
(88917708, '!l ents.FindByClass(\'gmt_monorail\')[1]:Remove()', '99'),
(88917708, '/sit', '99'),
(88917708, '/sit', '99'),
(88917708, '!l me:SetNWBool(\'inMonorail\', true)', '99'),
...
(88917708, '!l me:SetNWBool(\'inMonorail\', true)', '99'),
(88917708, '!l me:SetNWBool(\'inMonorail\', true)', '99'),
(88917708, '!l me:CreateRagdoll()', '99'),
(88917708, '!l me:CreateRagdoll()', '99'),
(88917708, 'Chat', '4'),
(88917708, 'Gmod Tower', '4'),
(312264716, 'f hsdrvcvfsrd ', '4'),
(88917708, '!l GAMEMODE:SetTime(100000)', '16'),
(88917708, '!l GAMEMODE:SetTime(10000000000000)', '16'),
(88917708, '!l GAMEMODE:SetTime(1000000000000000000000)', '16'),
(88917708, '!l GAMEMODE:SetTime(3)', '16'),
(312264716, 'no', '8'),
(312264716, 'haha', '8'),
(88917708, 'ta', '8'),
(312264716, '(thats me laughing)', '8'),
(88917708, 'nigger ball', '14'),
(312264716, '6', '14'),
(88917708, ':building: unite', '14'),
(312264716, ':eye:', '14'),
(88917708, 'nig', '14'),
(88917708, 'test', '99'),
(88917708, '!l me:EyeTrace().Entity:SetModelScale(10)', '99'),
(88917708, '!l me:EyeTrace().Entity:SetModelScale(10)', '99'),
(88917708, '!l me:GetEyeTrace().Entity:SetModelScale(10)', '99'),
(88917708, '!l me:EyeTrace().Entity:SetModelScale(20)', '99'),
(88917708, '!l me:GetEyeTrace().Entity:SetModelScale(20)', '99'),
(88917708, '!l me:GetEyeTrace().Entity:SetModelScale(35)', '99'),
(88917708, '/beckon', '99');
...
(2, 'Who was the villain of The Lion King?', 1, 'Films', 'Scar', 'Fred', 'Jafar', 'Vada', 44, 5, 11, 7, 1502879282, 0, 949104, 0),
...
(8, 'What is coal?', 1, 'Pot Luck', 'Fossil fuel', 'Element', 'Paper', 'A Star', 70, 13, 0, 6, 1502615015, 0, 0, 0),
...
(36, 'What is the name of the continent which contains the South Pole? ', 1, 'The Earth', 'Antarctica', 'Australia', 'Africa', 'Meridian', 43, 5, 5, 7, 1502592979, 0, 0, 0),
...
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7', 99),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7', 99),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7', 99),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [1][Bumpy]', 99),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7', 99),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7', 99),
...
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7', 99),
('multiserver', 'State changed to: 1', 16),
('start', 'Server start - gmt_sk_lifelessraceway01', 16),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7', 99),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7', 99),
...
('start', 'Server start - gmt_lobby2_r7', 99),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [1][Bumpy]', 99),
('start', 'Server start - gmt_ballracer_skyworld01', 4),
('multiserver', 'State changed to: 1', 4),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7', 99),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7', 99),
('multiserver', 'State changed to: 1', 4),
('start', 'Server start - gmt_ballracer_grassworld01', 4),
('multiserver', 'Authorized ips Bumpy/192.168.2.254:27007', 99),
('start', 'Server start - gmt_ballracer_paradise03', 4),
('multiserver', 'State changed to: 1', 4),
('multiserver', 'Authorized ips 192.168.2.254', 4),
('multiserver', 'State changed to: 3', 4),
('redirectplayers', 'Redirecting Bumpy@192.168.2.254:27007', 99),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [1][Bumpy]', 99),
('multiserver', 'State changed to: 1', 4),
('start', 'Server start - gmt_ballracer_grassworld01', 4),
('multiserver', 'State changed to: 1', 99),
...
('multiserver', 'State changed to: 1', 4),
('start', 'Server start - gmt_ballracer_skyworld01', 4),
('redirectplayers', 'Redirecting Bumpy@192.168.2.230:27006', 99),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [1][Bumpy]', 99),
('multiserver', 'State changed to: 1', 4),
('start', 'Server start - gmt_ballracer_sandworld02', 4),
('multiserver', 'State changed to: 1', 4),
('start', 'Server start - gmt_ballracer_sandworld02', 4),
('multiserver', 'State changed to: 1', 4),
('start', 'Server start - gmt_ballracer_sandworld02', 4),
...
('multiserver', 'State changed to: 1', 4),
('start', 'Server start - gmt_ballracer_skyworld01', 4),
('multiserver', 'State changed to: 1', 5),
('start', 'Server start - gmt_pvp_meadow01', 5),
('multiserver', 'State changed to: 2', 5),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [1][Basical]', 5),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [1][Basical]', 5),
('multiserver', 'State changed to: 1', 6),
('start', 'Server start - gmt_virus_sewage01', 6),
('multiserver', 'State changed to: 1', 16),
('start', 'Server start - gmt_sk_lifelessraceway01', 16),
('start', 'Server start - gmt_zm_arena_scrap01', 8),
('multiserver', 'State changed to: 1', 8),
('start', 'Server start - gmt_uch_camping01', 7),
('multiserver', 'State changed to: 1', 7),
('multiserver', 'State changed to: 2', 7),
('multiserver', 'State changed to: 1', 14),
('start', 'Server start - gmt_minigolf_moon01', 14),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [1][Basical]', 14),
('server', 'Empty server', 14),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [1][Basical]', 14),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [2][Bumpy]', 14),
('multiserver', 'State changed to: 1', 14),
('start', 'Server start - gmt_minigolf_moon01', 14),
('start', 'Server start - gmt_gr_nile', 20),
('multiserver', 'State changed to: 1', 20),
('start', 'Server start - gmt_zm_arena_scrap01', 20),
('multiserver', 'State changed to: 1', 20),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [3][Basical]', 20),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [2][Bumpy]', 20),
('server', 'Empty server', 20),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7', 99),
('start', 'Server start - gmt_lobby2_r7', 99),
('multiserver', 'State changed to: 1', 99),
...
('start', 'Server start - gmt_lobby2_r7', 99),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7h', 99),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7h', 99),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7c', 99),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7h', 99),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7c', 99),
...
('start', 'Server start - gmt_lobby2_r7c', 99),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r3', 99),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_build0s2b', 99),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [1][Bumpy]', 99),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7h', 99),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [1][Bumpy]', 99),
...
('start', 'Server start - gmt_lobby2_r7', 99),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [1][Bumpy]', 99),
('start', 'Server start - gmt_gr_ruins', 20),
('multiserver', 'State changed to: 1', 20),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [1][Bumpy]', 20),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7h', 99),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7', 99),
('condo', 'Bumpy paid and started a Condo Party. (22:29:58 - 10/05/2021)', 99),
('start', 'Server start - gmt_gr_nile', 20),
('multiserver', 'State changed to: 1', 20),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [1][Bumpy]', 20),
('multiserver', 'State changed to: 1', 7),
('start', 'Server start - gmt_uch_camping01', 7),
('multiserver', 'State changed to: 2', 7),
('server', 'Empty server', 7),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [1][Bumpy]', 7),
('multiserver', 'State changed to: 1', 7),
('start', 'Server start - gmt_uch_falloff01', 7),
('start', 'Server start - gmt_ballracer_spaceworld', 4),
('multiserver', 'State changed to: 1', 4),
('server', 'Empty server', 4),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [2][NotGaylien]', 4),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [3][Bumpy]', 4),
('multiserver', 'State changed to: 1', 4),
('start', 'Server start - gmt_ballracer_nightball', 4),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7', 99),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7', 99),
('condo', 'Bumpy paid and started a Condo Party. (23:25:25 - 23/06/2021)', 99),
('multiserver', 'State changed to: 1', 99),
('start', 'Server start - gmt_lobby2_r7c', 99),
('start', 'Server start - gmt_sk_rave', 16),
('multiserver', 'State changed to: 1', 16),
('sqldebug', 'Couldn\'t update player on disconnect calledconnected (true) connected (false) updateinprogress (true) Player [1][Bumpy]', 16),
('server', 'Empty server', 16),
('multiserver', 'State changed to: 1', 16),
('start', 'Server start - gmt_sk_rave', 16);
...
(4, '86.88.154.216', '27017', '0', '\0', '#nogame', '16', 'gmt_ballracer_nightball', '', 'ballrace', '1', '1621876897', '\0'),
(5, '192.168.2.230', '27019', '1', 'LÆÌ', '1/2||||3/6', '16', 'gmt_pvp_meadow01', '', 'pvpbattle', '2', '1603634950', '\0'),
(6, '192.168.2.230', '27022', '2', 'œÈLÆÌ', '-15.524993896484||||2/10', '16', 'gmt_virus_sewage01', '', 'virus', '1', '1603635194', ''),
(7, '192.168.2.230', '27021', '7', '›‘LÆÌ', '3||||6/15', '16', 'gmt_uch_falloff01', '', 'ultimatechimerahunt', '1', '1621876460', '\0'),
(8, '192.168.2.230', '27023', '2', 'œÈLÆÌ', '119.82000732422||||2/5', '16', 'gmt_zm_arena_scrap01', '', 'zombiemassacre', '1', '1603636084', ''),
(14, '192.168.2.230', '27018', '0', '\0', '#nogame', '16', 'gmt_minigolf_moon01', '', 'minigolf', '1', '1603638353', '\0'),
(16, '192.168.2.230', '27020', '0', '\0', '#nogame', '64', 'gmt_sk_rave', '', 'sourcekarts', '1', '1624486039', '\0'),
(99, '192.168.2.230', '27016', '1', 'LÆÌ', '', '64', 'gmt_lobby2_r7c', '', 'gmtlobby', '1', '1624484046', '');
...
INSERT INTO `gm_users` (`id`, `name`, `steamid`, `betatest`, `CreatedTime`, `ip`, `levels`, `pvpweapons`, `clisettings`, `MaxItems`, `inventory`, `BankLimit`, `bank`, `plysize`, `achivement`, `Roomdata`, `money`, `LastOnline`, `hat`, `tetrisscore`, `time`, `ramk`, `ball`, `faceHat`, `pendingmoney`, `chips`) VALUES
('194744599', 'NotGaylien', 'STEAM_0:1:97372299', '', '', '90.218.215.98', '\0', 'GHÁ45ÕB?ñT7úL]', '', '', '', '', '', '', '3$\Z+!2T,S,arE#a20*ÑbF*Áb1!2M', '', 2298, '1621876879', '', '', '1553.02233886718', 0, 0, 0, NULL, 0),
('312264716', 'Basical', 'STEAM_0:0:156132358', '', '', '78.16.205.106', '\0', 'GHÁ45ÕB?ñT7úL]', '', '', '', '', '', '4', '\09ç*qB3$11*‘‚É\"‘\"‡%!0+A’µ)1‘#á6)á\"a»)‚(B¦*Q2Š*B4*12G%AD\"A *!RE%a*Ñ2‚*Á2I*±°', '', 5456, '1603639042', '', '', '9427.826705932559', 0, 0, 0, NULL, 0),
('88917708', 'Bumpy', 'STEAM_0:0:44458854', '', '', '192.168.2.230', '\0', 'GHÁ45ÕB?ñT7úL]', '\0á\0 \0‘', '', '\0‡\0\0¾.\0\0\rÈü\0\0Í©\0\0É\0\0Ð\0\0Óf\0\0-\0\0Õl\0\04Ö\0', '', '', '', '\0Cba#(C%!bJ#!€!qá\"!€! !ÓÕ\"$\"a)#’1$B6%É%1‡%!´!‚µ$Ñ2²)12~+‘+ž$‘›\'¡Æ*a\"Š*A’Œ%Ab$q\"D,Q *ñE*á2B*Ñ’‚*Á’¹*±À', 'H®€\0¨ÿ^.€\0\0÷e\0oTe\0', 14681, '1624484507', '0', '23', '96543.31648254412', 0, 0, 0, 0, 0);
...
--
ALTER TABLE `gm_gomap`
  MODIFY `serverid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
